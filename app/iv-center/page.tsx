        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-16">
              <h2 className="text-3xl font-bold mb-6">수액센터 소개</h2>
              <p className="text-gray-600 leading-relaxed mb-8">
                세로움 클리닉의 수액센터는 최신 의료 장비와 전문 의료진을 통해<br />
                고객님의 건강과 아름다움을 위한 최적의 수액 치료를 제공합니다.
              </p>
              <div className="grid md:grid-cols-2 gap-8 mb-16">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-bold mb-4">전문 의료진</h3>
                  <p className="text-gray-600">
                    풍부한 임상 경험을 바탕으로 고객님의 상태에 맞는<br />
                    최적의 수액 처방을 제안해 드립니다.
                  </p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-bold mb-4">안전한 시설</h3>
                  <p className="text-gray-600">
                    무균 처치실과 최신 의료 장비를 갖춘<br />
                    안전하고 쾌적한 환경을 제공합니다.
                  </p>
                </div>
              </div>
